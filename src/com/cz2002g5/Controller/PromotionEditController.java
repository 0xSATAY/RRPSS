        ...
        while (true) {
            ...
            if (sc.hasNextInt()) {
                ...
                for (int i=0;i<promotionalSet.getSetItems().size();i++) {
                    ...
                    System.out.println(i + 1 + ". " + setItem.getName() + " - " +
                ...
                System.out.println("Price of promo set: " +
    ...
    public void updateItem(RRPSS pos) throws IOException {
        while (true) {
            ...
            if (selection >= 0 && selection < promotionalSets.size()) {
                ...
                ((UpdatePromoItemView) RRPSS.getCurrentView(pos)).showUpdateNameView(itemSelected.getName());
