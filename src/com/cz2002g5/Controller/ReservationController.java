...
public void createReservation(RRPSS pos) {
        ...
        if (res > -1) {
            ...
            System.out.println("Reservation for table " + (res+1) + " has been added for " + name + " at " + date + " " + time + " for " + pax + ".");
        } else {
            System.out.println("Failed to reserve table as there are no more available tables on " + date + " at " + time + " for " + pax + "\n");
        }
    }
